...
if($this->customer){
    include 'application/themes/default/views/header.php';
}else{
?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>MarketPlace<?php echo (isset($page_title)) ? ' :: ' . $page_title : ''; ?></title>
            ...
            <div class="navbar navbar-fixed-top">
                <div class="navbar-inner">
                    <div class="container">
                        ...
                        <a class="brand" href="<?php echo $admin_url; ?>">Market Place</a>
                            ...
                            <ul class="nav">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php if ($this->auth->check_access('Admin')) : ?>
											...
											<li><a href="<?php echo $admin_url; ?>vendors">Vendors</a></li>
											<li><a href="<?php echo $admin_url; ?>partners">Partners</a></li>
                                ...
                                if ($this->auth->check_access('Admin') || $this->auth->check_access('Partner')) :
                                    ?>
                                    <li class="dropdown">
                                ...
                                if ($this->auth->check_access('Admin')) :
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                           <?php /* ?><li><a href="<?php echo $admin_url; ?>banners"><?php echo lang('common_banners') ?></a></li> <?php */ ?>
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                       <!--     <li><a href="<?php echo $admin_url; ?>settings">Website Configuration</a></li>
    ...
    <?php   endif; ?>
                            ...
                            <ul class="nav pull-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo site_url($this->config->item('admin_folder') . '/dashboard'); ?>">Dashboard</a></li>
                                        <li><a href="<?php echo site_url(); ?>"><?php echo lang('common_front_end') ?></a></li>
                                        <li><a href="<?php echo site_url($this->config->item('admin_folder') . '/login/logout'); ?>">Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div><!-- /.nav-collapse -->
