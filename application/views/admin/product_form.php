...
?>
<?php echo form_open($module . '/products/form/' . $id, $attributes); ?>
<div class="row">
    <div class="span8">
        <div class="tabbable">
        ...
        <div>
            ...
            <label for="price_fixed" class="radio inline no-padding-top">
                ...
                $data = array(
                    ...
                    'checked' => set_value('price_option', $price_type) === 'fixed'
                );
            ...
            <label for="price_size" class="radio inline no-padding-top">
                ...
                $data = array(
                    ...
                    'checked' => set_value('price_option', $price_type) === 'size'
                );
                ...
                <div id="price_size_options" style="display: none;">
                    <div class="sizes_container">
                        ...
                        for ($i = 0; $i < count($size['name']); $i++) {
                            ...
                            echo '<div class="size_container"><input type="text" class="textbox inline width-35" name="size[name][]" placeholder="' . lang('Size_name') . '" value="' . $size['name'][$i] . '"><input type="text" class="textbox inline width-16" name="size[price][]" placeholder="' . lang('price') . '" value="' . $size_price . '"><input type="text" class="textbox inline width-16" name="size[sale_price][]" placeholder="' . lang('saleprice') . '" value="' . $size_sale_price . '"><input type="text" class="textbox inline width-9" name="size[stock][]" placeholder="' . lang('stock') . '" value="' . $size_stock . '"></div>'; //<a style="display: inline-block; margin: 9px 0px 0px 11px;" class="btn remove-size"><i class="icon-minus-sign"> </i></a>
                        }
                        ?>
                    </div>
                    <br/>
...
<script type="text/javascript">
    ...
    function addCreateMoreAddons() {
        $('#createbuttondiv').append('<div class="form-group madSubAddonNew2 form-horizontal addonmarginbottom" >' +
                ...
                '<label class="checkbox inline margin-l"><input type="checkbox" class="form-control input-sm textaddonbottom" value="required" name="createmainaddons[' + special_row + '][required]"><?php echo lang('required'); ?></label>' +
