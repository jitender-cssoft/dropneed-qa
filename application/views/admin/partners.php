...
<table class="table table-striped partners">
    <thead>
        <tr>
            ...
            <th><a href="<?php echo site_url($this->config->item('admin_folder') . '/partners/firstname/'); ?>/<?php echo ($field == 'firstname') ? $by : ''; ?>"><?php echo lang('firstname'); ?>
                    <?php
                    if ($field == 'firstname') {
                        echo ($by == 'ASC') ? '<i class="icon-chevron-up"></i>' : '<i class="icon-chevron-down"></i>';
                    }
                    ?></a>
            </th>

            <th><a href="<?php echo site_url($this->config->item('admin_folder') . '/partners/lastname/'); ?>/<?php echo ($field == 'lastname') ? $by : ''; ?>"><?php echo lang('lastname'); ?>
                    <?php
                    if ($field == 'lastname') {
                        echo ($by == 'ASC') ? '<i class="icon-chevron-up"></i>' : '<i class="icon-chevron-down"></i>';
                    }
            ...
            <th><a href="<?php echo site_url($this->config->item('admin_folder') . '/partners/email/'); ?>/<?php echo ($field == 'email') ? $by : ''; ?>"><?php echo lang('email'); ?>
                    <?php
                    if ($field == 'email') {
                        echo ($by == 'ASC') ? '<i class="icon-chevron-up"></i>' : '<i class="icon-chevron-down"></i>';
                    }
            ...
            <th><?php echo lang('partner_vendors'); ?></th>
