      ...
      <div id="navbar" class="navbar-collapse collapse navbar-right">
        <ul class="nav nav-justified">
          ...
          <li><a href="<?php echo site_url(); ?>how_it_work"><i class="icon"><img src="<?php echo site_url(); ?>assets/front/images/how-dropneed-icon.png" /></i>How dropneed works</a>      </li>
			...
			<li><a href="<?php echo site_url('login'); ?>"><span class="btn login-btn">Login</span></a></li>
			<?php } 
			else { 	?>
				<li class="with-arrow"><?php echo isset($userResult['firstname'])?'Hello '.$userResult['firstname']:'Welcome'; ?>
					<ul class="sub-main-menu">
						<li>Your account</li>
						<li>Your order</li>
						<li>How dropneed works</li>
						<li>Reffer friends</li>
						<li>Reffer friends</li>
						<li><a href="<?php echo site_url('logout'); ?>">Logout</a></li>
						<li>Press|Term|Privacy</li>
					</ul>
				</li>
			<?php } ?>
			<li><a href="<?php echo site_url('login'); ?>"><span class="btn login-btn">Login</span></a></li>
