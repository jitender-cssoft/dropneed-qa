	...
	<div class="body-area">
		<div class="row">
			...
			<div class="col-sm-9 pull-left col-xs-12">
				<div class="white-bg">
					<div class="product-logo"><img src="<?php echo site_url(); ?>assets/front/images/deault_food_image.png"  /></div>
					...
					<table class="table delivery-table"> 
						...
						<tbody>
							...
							<tr><td>Min. Delivery Amount </td><th><?php echo config_item('myCurrency'); ?><?php echo !empty($ventureResult['min_delivery_amount'])?$ventureResult['min_delivery_amount']:'0'; ?> </th></tr>
							<tr>
