					...
					<div class="row">
						...
						<div class="col-sm-8">
							...
							<div class="product-info">
								...
								<input type="number" id="popupProduct-qty-<?php echo $i; ?>" min="1"  class="form-control" name="popupProduct_qty" size="3" value="1" /><p>UNIT(S)</p>
							</div>
							<!--product info //-->
						</div>
					</div>		
						...
						<?php foreach($addOn['subaddons'] as $singleItem) { ?>														
							<div class="col-sm-3">
								<div class="checkbox-txt">
									<input type="checkbox" data-index="<?php echo $i?>" data-adonName="<?php echo $name; ?>" data-adonName="<?php echo $name; ?>" data-adonCount="<?php echo $addOn['mainaddoncnt']; ?>"  class="adon-checkbox <?php echo $name; ?>" name="addOnPrice[<?php echo $name; ?>][]" value="<?php echo $singleItem['subaddonsprice']; ?>" /> <p><?php echo $singleItem['subaddonsname']; ?> [<?php echo $singleItem['subaddonsprice']; ?>]</p>
								</div>
							</div>
						<?php } ?>
