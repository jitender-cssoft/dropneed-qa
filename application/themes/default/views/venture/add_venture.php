...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#addMore').on('click', function () {
            $('#removeMore').show();
            $('<div id="removemoreafter" class="row-fluid"><div class="span6"><label>Additional Working Day</label><select class="span12 example" style="width:100%;" id=example-getting-started' + i + ' name="days[]" multiple><option value="0">Sunday</option><option value="1">Monday</option><option value="2">Tuesday</option><option value="3">Wednesday</option><option value="4">Thursday</option><option value="5">Friday</option><option value="6">Saturday</option></select></div><div class="span3"><label>Start Time</label><input type="text" id=f_starttime' + i + ' class="span12 required" name="start_time[]"></div><div class="span3"><label>End Time</label><input type="text" id=f_endtime' + i + ' class="span12 required" name="end_time[]"></div></div>').appendTo(extDiv);
            $('.example').multiselect();
