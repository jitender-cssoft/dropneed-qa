...
//default values are empty if the product is new
        ...
        $data['price_type'] = $this->input->post('price_option');
...
//no error checking on these
        ...
        if ($price_option == "size") {
            $this->form_validation->set_rules('size[price][]', 'lang:price', 'trim|numeric|floatval|required');
            //$this->form_validation->set_rules('size[sale_price][]', 'lang:saleprice', 'trim|numeric|floatval');
            $this->form_validation->set_rules('size[stock][]', 'lang:stock', 'trim|integer');
        }
